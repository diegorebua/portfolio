...
<template>
  <div :class="['min-h-screen transition-colors duration-500 overflow-hidden', isDarkMode ? 'bg-transparent text-zinc-300' : 'bg-white text-slate-900']">
      ...
      <section id="hero" class="min-h-screen flex items-center justify-center pt-20 section-dot-bg">
        <div class="container mx-auto px-4 sm:px-6 text-center">
          ...
          <div class="flex flex-row items-center justify-center gap-2 w-full px-8 mt-6">
            <a href="#projects" @click.prevent="handleNavClick('#projects')" :class="['flex-1 text-center py-2.5 rounded-full font-bold text-[11px] uppercase tracking-wider transition-all shadow-xl active:scale-95 whitespace-nowrap', isDarkMode ? 'bg-white text-black hover:bg-zinc-200' : 'bg-slate-900 text-white hover:bg-blue-600 shadow-slate-900/10']">
              Projetos
            </a>
            <a href="#about" @click.prevent="handleNavClick('#about')" :class="['flex-1 text-center py-2.5 border rounded-full font-bold text-[11px] uppercase tracking-wider transition-all active:scale-95 whitespace-nowrap', isDarkMode ? 'bg-transparent text-white border-zinc-700 hover:border-zinc-500' : 'bg-white text-slate-900 border-slate-100 hover:border-slate-100']">
              Sobre Mim
            </a>
          </div>
        </div>
    ...
    <footer :class="['py-12 md:py-20 border-t', isDarkMode ? 'bg-transparent border-zinc-800' : 'bg-white border-slate-100']">
      <div class="container mx-auto px-4 sm:px-6 text-center">
        <div class="flex justify-center space-x-8 md:space-x-12 mb-8 md:mb-12">
          ...
          <a href="https://www.linkedin.com/in/diegorebu%C3%A1/" target="_blank" aria-label="LinkedIn" :class="['transition-all hover:scale-110 active:scale-95', isDarkMode ? 'text-zinc-500 hover:text-white' : 'text-slate-400 hover:text-blue-600']">
          ...
          <a href="https://www.instagram.com/diegorebua/" target="_blank" aria-label="Instagram" :class="['transition-all hover:scale-110 active:scale-95', isDarkMode ? 'text-zinc-500 hover:text-white' : 'text-slate-400 hover:text-blue-600']">
