...
<template>
  <footer class="py-12 md:py-16 relative z-10" style="border-top: 1px solid var(--color-border)">
    <div class="max-w-6xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
      <div class="flex items-center gap-3">
        ...
        <p class="mono text-xs uppercase tracking-wider" style="color: var(--color-text-dim)">
      ...
      <div class="flex items-center gap-6">
        <a
          ...
          aria-label="GitHub"
          class="transition-all duration-300 hover:scale-110 hover:text-[var(--color-accent-text)]"
