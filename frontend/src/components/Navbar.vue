...
<template>
  <nav :class="[
    ...
    <div class="container mx-auto px-6 flex justify-between items-center">
      <a href="#" class="select-none text-base font-bold tracking-tight text-white hover:text-zinc-300 transition-colors" aria-label="Diego Rebuá — Início">
        Diego Rebuá
      </a>
      <div class="flex items-center space-x-8">
        ...
        <div class="flex items-center space-x-4">
          <a href="#contact" @click.prevent="emit('navClick', '#contact')" class="px-5 py-2 rounded-full font-bold text-xs uppercase transition-all bg-white text-black hover:bg-zinc-200">Contato</a>
        </div>
      </div>
    </div>
  </nav>
