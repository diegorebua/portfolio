  ...
  <div class="min-h-screen transition-colors duration-500 bg-transparent text-zinc-300">
    ...
    <main>
      ...
      <section id="hero" class="min-h-screen flex items-center justify-center pt-20 section-dot-bg">
        <div class="container mx-auto px-4 sm:px-6 text-center">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#projects" @click.prevent="handleNavClick('#projects')" class="w-full sm:w-auto px-8 md:px-10 py-4 rounded-full font-bold transition-all shadow-xl active:scale-95 bg-white text-black hover:bg-zinc-200">
              Ver Projetos
            </a>
            <a href="#about" @click.prevent="handleNavClick('#about')" class="w-full sm:w-auto px-8 md:px-10 py-4 border rounded-full font-bold transition-all active:scale-95 bg-transparent text-white border-zinc-700 hover:border-zinc-500">
              Sobre Mim
            </a>
          </div>
        </div>
          ...
          <div class="max-w-5xl mx-auto">
            <div class="flex flex-col md:flex-row gap-10 md:gap-16 items-start">
              <div class="w-full md:w-1/3" data-motion>
                <h2 class="text-sm font-black text-blue-600 uppercase tracking-[0.3em] mb-4">Perfil</h2>
      ...
      <section id="skills" class="py-16 md:py-32 border-y border-zinc-800">
        <div class="container mx-auto px-4 sm:px-6">
          <div class="max-w-5xl mx-auto">
            <h2 data-motion class="text-sm font-black text-blue-600 uppercase tracking-[0.3em] mb-8 md:mb-12 text-center">Tecnologias</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              <div v-for="(project, idx) in PROJECTS" :key="project.id" :data-motion="`${idx * 100}ms`" class="group">
                ...
                >
                  ...
                  <div v-else class="w-full h-full flex flex-col items-center justify-center p-6 text-center bg-gradient-to-br from-zinc-900/90 via-zinc-900 to-zinc-800/60 border border-zinc-800/80">
                    <div class="w-12 h-12 rounded-full bg-blue-600/10 border border-blue-500/20 flex items-center justify-center mb-3 text-blue-500">
                      <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                    </div>
                    <span class="text-xs font-bold text-zinc-500 tracking-widest uppercase">Em Breve</span>
                  </div>
                ...
                <div v-if="project.tech && project.tech.length" class="flex flex-wrap gap-2 mb-3">
      ...
      <section id="experience" class="py-16 md:py-32 border-y bg-zinc-900/10 border-zinc-800">
        <div class="container mx-auto px-4 sm:px-6">
          <div class="max-w-4xl mx-auto">
            <h2 data-motion class="text-sm font-black text-blue-600 uppercase tracking-[0.3em] mb-8 md:mb-12">Trajetória</h2>
